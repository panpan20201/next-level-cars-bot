...
def get_currency_keyboard():
    return types.ReplyKeyboardMarkup(keyboard=[[types.KeyboardButton(text="KRW"), types.KeyboardButton(text="USDT")], [types.KeyboardButton(text="⬅️ Назад")]], resize_keyboard=True)
